...
form.addEventListener('submit', function (e) {
    e.preventDefault();
    var doc;
    (type.value === 'invoice') ? doc = new Invoice_js_1.Invoice(tofrom.value, details.value, amount.valueAsNumber) : doc = new Payment_js_1.Payment(tofrom.value, details.value, amount.valueAsNumber);
